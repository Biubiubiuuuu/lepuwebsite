...
var doc = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/entity.AdvertRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/entity.CarouselRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/admin/new/propertyInfo": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "模型类型 0-转让 ｜ 1-出售 ｜ 3-出租",
                        "name": "model_type",
                        "in": "formData"
                    },
                    {
        ...
        "/api/v1/admin/new/propertyInfo/{id}": {
            "put": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/api/v1/admin/new/qzqgPropertyInfo/{id}": {
            "put": {
                "security": [
                    {
                        "ApiKeyAuth": []
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/entity.PayInfoRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/entity.PayMethondRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/admin/proInfo/payInfo/{id}": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/entity.PayInfoRequestByProInfo"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/admin/propertyInfo/notprotect/{id}": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
    ...
    "definitions": {
        ...
        "entity.PayInfoRequestByProInfo": {
            "type": "object",
            "properties": {
                "actual_amount": {
                    "description": "实收金额",
